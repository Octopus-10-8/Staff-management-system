...
<body>
	...
	<form class="form-horizontal" action="employeeUpdateServlet" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" name="employeeName"
							value="${ employee.employeeName}" placeholder="请输入员工姓名" />
					</div>
				</div>
			</div>
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" name="employeeAge"
							value="${ employee.employeeAge}" placeholder="请输入员工年龄" />
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" readonly="readonly" class="form-control"
							value="${ employee.employeeTIme}"
							onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="employeeTIme"
							placeholder="请输入员工生日" />
					</div>
				</div>
			</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" name="employeePhone"
							value="${ employee.employeePhone}" placeholder="请输入电话号码" />
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select class="form-control" name="employeeSex">
							<option ${ employee.employeeSex=="保密"?"selected":""}>保密</option>
							<option ${ employee.employeeSex=="男"?"selected":""}>男</option>
							<option ${ employee.employeeSex=="女"?"selected":""}>女</option>
						</select>
					</div>
				</div>
			</div>
						...
						<select name="departmentId" class="form-control">
							<c:forEach items="${list }" var="de">
								<option value="${de.departmentId }"
									${employee.departmentId==de.departmentId?'selected':'' }>${de.departmentName }</option>
							</c:forEach>
						</select>
					</div>
				</div>
		...
		<h5 class="page-header alert-info"
			style="margin: 0px; padding: 10px; margin-bottom: 10px;">账户信息</h5>
		<!-- 222 -->
		<div class="row">
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" name="userId"
							value="${employee.userId }" placeholder="请输入员工帐号" />
					</div>
				</div>
			</div>
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" name="userPw"
							value="${employee.userPw }" placeholder="请输入员工密码" />
		...
		<div class="row">
			<div class="col-sm-3 col-sm-offset-4">
				<input type="submit" class="btn btn-success" value="修改员工信息"> <input
