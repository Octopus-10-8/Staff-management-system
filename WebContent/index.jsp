...
<base href="<%=basePath%>">
		...
		<!-- <![endif]-->
		<!--[if IE]>
         <script type="resource/text/javascript">window.jQuery || document.write("<script src='assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
        <![endif]-->
			...
			<div class="navbar-container" id="navbar-container">
               ...
               <ul class="nav ace-nav">	
				...
				<a data-toggle="dropdown" href="#" class="dropdown-toggle">
				 <span  class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临:${empl.employeeName}</small>超级管理员</span>
...
<script type="text/javascript">
                  ...
                  <li>
					<a href="#" class="dropdown-toggle"><i class="icon-user"></i><span class="menu-text"> 员工管理 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                             
                    <li class="home"><a href="javascript:void(0)" name="DepartmentQuery" title="部门管理"  class="iframeurl"><i class="icon-double-angle-right"></i>部门管理</a></li>
                    <li class="home"><a href="javascript:void(0)" name="employeeServlet" title="员工管理"  class="iframeurl"><i class="icon-double-angle-right"></i>员工管理</a></li>
